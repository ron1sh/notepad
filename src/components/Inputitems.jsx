            ...
            <div className={`rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] flex flex-col justify-center p-3 min-w-[75vw] max-w-[75vw] min-h-[80vh] max-h-[80vh]  gap-4 overflow-scroll px-12 ${hideScrollbar}`}>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex justify-end items-center mb-1 hover:cursor-pointer">
                        <button onClick={()=>navigate("/",{replace:true})} className="text-3xl md:text-5xl hover:text-red-500 cursor-pointer p-2">&times;</button>
                    </div>
                    <div className="flex justify-end hover:cursor-pointer">
                        <button className="border text-2xl font-bold border-black px-8 py-2 hover:cursor-pointer hover:bg-[#5e8c6b] rounded-2xl" onClick={postingdata}>Post</button>
                    </div>
                </div>
            </div>
        </div>
